"""Insert Pisces M8-M9 interpretations"""
import asyncio
import sys
import uuid
...
from scripts.batch_sprint4_pisces_m8_m9 import BATCH_PISCES_M8_M9
...
if __name__ == "__main__":
    print(f"Insertion de {len(BATCH_PISCES_M8_M9)} interpretations Pisces M8-M9...")
    asyncio.run(insert_batch(BATCH_PISCES_M8_M9))
