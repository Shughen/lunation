"""Insert Scorpio M9-M10 interpretations"""
import asyncio
import sys
import uuid
...
from scripts.batch_sprint4_scorpio_m9_m10 import BATCH_SCORPIO_M9_M10
...
if __name__ == "__main__":
    print(f"Insertion de {len(BATCH_SCORPIO_M9_M10)} interpretations Scorpio M9-M10...")
    asyncio.run(insert_batch(BATCH_SCORPIO_M9_M10))
