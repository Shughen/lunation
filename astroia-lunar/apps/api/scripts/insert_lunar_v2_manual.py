"""
Insert manual Opus 4.5 lunar interpretations
Usage: python scripts/insert_lunar_v2_manual.py
"""
...
# === INTERPRETATIONS A INSERER ===
# Format: {'moon_sign': 'X', 'moon_house': N, 'lunar_ascendant': 'Y',
#          'interpretation': '...', 'weekly_advice': {...}}

BATCH = [
    # Les interpretations seront ajoutees ici
]
...
if __name__ == "__main__":
    if BATCH:
        ...
        print("Aucune interpretation a inserer. Ajoutez des items dans BATCH.")
